...
var spbd_reveal_closer_today_button = $('#reveal_close_today');
if (spbd_reveal_closer_today_button.length > 0) {
  spbd_reveal_closer_today_button.on('click', function() {
    localStorage.setItem("spbd_close_today", 'true');
    localStorage.setItem("spbd_close_today_date", new Date() );
  });
}
