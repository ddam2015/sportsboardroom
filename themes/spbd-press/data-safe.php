...
?>
  <section id="content" class="grid-x grid-margin-x site-main large-padding-top xlarge-padding-bottom<?php if ( $spbd_ad_info['go'] ) echo $spbd_ad_info['ad_section_class']; ?>" role="main">
