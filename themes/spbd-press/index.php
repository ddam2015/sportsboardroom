...
<section id="content" class="grid-x site-main <?php echo ( has_post_thumbnail( $post->ID ) && !is_product() ) ? 'small-padding-top ' : 'large-padding-top '; if ( $spbd_ad_info['go'] ) echo $spbd_ad_info['ad_section_class']; ?>" role="main">
