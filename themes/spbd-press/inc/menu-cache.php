...
// 		write_log( sprintf( 'spbd Cache hit: Menu output was fetched in %d ms', round( $wp_menu_generation_time * 1000 ) ) );
// 	}
// 	return $output;
// }, 11, 2 );
// /**
...
// 	global $wp_menu_generation_start;
// 	$wp_menu_generation_time = microtime( true ) - $wp_menu_generation_start;
// 	write_log( sprintf( 'spbd Cache miss: Menu output was generated in %d ms', round( $wp_menu_generation_time * 1000 ) ) );
// 	return $nav_menu;
// }, 11, 2 );
...
// 	// but we need to make sure the cache is not out of sync - transients are unreliable.
// 	$cached_versions = get_transient( 'menu-cache-menuid-' . $args->menu->term_id );
//   write_log( sprintf( 'spbd Cache?' . $cached_versions ) );
// 	if ( false !== $cached_versions ) {
